...
( function() {
		...
		// forEach method, @link: https://toddmotto.com/ditch-the-array-foreach-call-nodelist-hack/.
		...
		const schoolButtons = document.querySelectorAll( '.select-highschool' );

		// For each column button element add click event.
		forEach( schoolButtons, function( index, el ) {
		...
		const columnButtons = document.querySelectorAll( '.select-col' );

		// For each column button element add click event.
		forEach( columnButtons, function( index, el ) {
